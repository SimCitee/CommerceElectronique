		...
		<div class="row">
			<div class="col-md-8 col-md-offset-2">
				...
				<div class="box">
					...
					<div class="form-group">
						<label for="password_confirmation" class="col-sm-2 control-label">{{ Lang::get('users.repeat_password') }}</label>
						<div class="col-sm-10">
							<input type="password" class="form-control" id="password_confirmation" name="password_confirmation" maxlength="512" placeholder="{{ Lang::get('users.repeat_password') }}">
						</div>
					</div>
